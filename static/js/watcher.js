...
watcher.init = function() {
    ...
    var watchedMenuHeader = document.createElement("div");
    watchedMenuHeader.className = "header";
    watchedMenuHeader.appendChild(watchedMenuLabel);
    ...
    watchedMenuHeader.appendChild(closeWatcherMenuButton);
   
    watcher.watchedMenu.appendChild(watchedMenuHeader);
    ...
    draggable.setDraggable(watcher.watchedMenu, watchedMenuHeader);
